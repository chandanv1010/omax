...
@endif
    <div class="uk-container uk-container-center">
        ...
        <div class="uk-container uk-container-center">
        <div class="panel-body uk-flex uk-flex-beetween uk-flex-center">
            <div class="thumbnail-section uk-flex uk-flex-middle">
                <div class="vertical-carousel" id="thumbnailCarousel">
                    @if (isset($gallery))
                ...
                <img src="{{ $image }}" alt="Tay nắm cửa chính" class="main-image img-zoomin" id="mainImage">
